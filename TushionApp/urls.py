...
#  ----------------------------tutor
    ...
    path('ViewTimeTabel/',views.ViewTimeTabel),
    ...
    path('EditNotification/',views.EditNotification),
    ...
    path('EditAttendence/',views.EditAttendence),
    ...
    path('EditTestResult/',views.EditTestResult),
